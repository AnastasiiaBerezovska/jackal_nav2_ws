...
public:
            ...
            ParamServer("lio_sam_imu_preintegration", options)
    {
        ...
        imuIntegratorImu_ = new gtsam::PreintegratedImuMeasurements(std::move(p), prior_imu_bias); // IMU message thread
	imuIntegratorOpt_ = new gtsam::PreintegratedImuMeasurements(std::move(p), prior_imu_bias); // optimization
